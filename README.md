...
## Requirements
* An Apple iPhone or iPad with iOS 14.0 (or later). Developed on iOS 14.1...15.2, earlier versions not tested.
* [Homebridge](https://homebridge.io/) v1.3.8 (or later). Developed on Homebridge 1.1.116....1.3.8, earlier versions not tested.
